...
export const INPUT_TOOLTIPS = {
  ...
  fixedSalaryAmount: 'The exact annual salary your corporation pays you. Common choices: just above CPP maximum ($74,600 in 2026) for full CPP, or higher to generate RRSP room. Corporate tax deduction equals salary + employer CPP/EI costs.',
